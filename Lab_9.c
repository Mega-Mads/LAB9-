...
//!NOTE FOR TA!: When running my code please use command prompt and do LAB_9.exe<input.txt and the output will primnt
// RecordType
struct RecordType
{
    int id;
...
void displayRecordsInHash(struct HashTable *ht) {
    for (int i = 0; i <= 23; i++) { //ta said to do this so it prints out index till 23
